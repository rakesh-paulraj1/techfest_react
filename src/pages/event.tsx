...
const Popup = ({ event, onClose }: { event: { title: string; description: string; price: string; imgSrc: string ,event_id:string,event_teamsize:string,event_qr:string,event_register_link:string,event_rulebook:string,event_venue:string,event_time:string }; onClose: () => void }) => {
  ...
  <p className="font-semibold text-lg">{'Team size : ' + event.event_teamsize}</p>
  <p className="font-semibold text-lg">{'Event Time : ' + event.event_time}</p>
  <p className="font-semibold text-lg">{'Event Venue : ' + event.event_venue}</p>
...
const EventsPage = () => {
  ...
  const events = [
    {
      ...
      event_price: "Round 1(free),Round 2(400) Per Team",
      event_image: "assets/eventimages/hackathon.png",
    ...
    },
    {
      event_name: "Marathon",
      event_price: "50",
      event_image: "assets/eventimages/marathon.png",
      ...
      event_price: "300 Per Team ",
      event_image: "assets/eventimages/Capturetheflag.png",
    ...
    },
    {
      ...
      event_price: "150 Per Person",
      event_image: "assets/eventimages/cloudcraft.png",
      event_description: "Unlock the world of drone technology with our comprehensive workshop at TechSpectrum '24, where you'll learn the basics of drone design, programming, and operations.Whether you're a beginner interested in drones or someone looking to enhance their technical skills, this workshop will provide hands-on experience and deep insights into drone development and control.",
      event_id: "E003",
      event_time:"10:00 AM - 1:30 PM",
      event_venue:"IST 615",
      event_teamsize: "1",
      event_qr: "/images/event3_qr.jpg",
      event_register_link: "https://forms.gle/ppVjqTua7ZJNLP3H6",
      event_rulebook: "",
    },
    {
      event_name: "Cosmic Connection",
      event_price: "500 Per Team ",
      event_image: "assets/eventimages/cosmicconnection.jpeg",
    ...
    {
      event_name: "DevStorm",
      event_price: "400 Per Team",
      event_image: "assets/eventimages/DEVSTORM.png",
    ...
    },
    {
      ...
      event_price: "350 Per Team",
      event_image: "assets/eventimages/pitchperfect.png",
      ...
      event_price: "250 Per Team",
      event_image: "assets/eventimages/stumpthedata.png",
    ...
    },
    {
      ...
      event_price: "150",
      event_image: "/assets/eventimages/Quantum.png",
    ...
    },
    {
      ...
      event_price: "150",
      event_image: "assets/eventimages/verizon.png",
      ...
      event_price: "300 Per Team",
      event_image: "assets/eventimages/sharktank.png",
      event_description: "The Startup Pitch Competition, inspired by Shark Tank, is an intercollege event hosted by the Entrepreneurship Development Cell (EDC) at SRMIST Trichy. It offers aspiring entrepreneurs a platform to present their business ideas or prototypes to a panel of judges. The event encourages collaboration, innovation, and entrepreneurship among students from various colleges. Participants will receive valuable feedback, hands-on training, and networking opportunities with industry experts. Winners will be awarded prestigious prizes, including certificates and recognition for their entrepreneurial efforts.",
      event_id: "E005",
      event_time:"9:00 AM - 1:00 PM",
      event_venue:"IST 101",
      event_teamsize: "1-3",
    ...
    },
    {
      ...
      event_price: "Free",
      event_image: "assets/eventimages/gfg.png",
      ...
      event_id: "E005",
      event_time:"24/10/2024 AND 25/10/2024",
      event_venue:"ONLINE",
      event_teamsize: "1",
      event_qr: "/images/event5_qr.jpg",
  ...
  const handleEventClick = (event: { title: string; description: string; price: string; imgSrc: string; event_id: string,event_teamsize:string,event_qr:string ,evnet_register_link:string,event_rulebook:string,event_time:string,event_venue:string }) => {
    setSelectedEvent({
      title: event.title,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {data.map((event, index) => (
            <EventCard
              key={index}
              event={event}
              onClick={() => handleEventClick({ title: event.title, description: event.description, price: event.price, imgSrc: event.src, event_id: event.event_id, event_teamsize: event.event_teamsize,event_qr:event.event_qr,event_register_link:event.event_register_link,event_rulebook:event.event_rulebook,event_time:event.event_time,event_venue:event.event_venue } as { title: string; description: string; price: string; imgSrc: string; event_id: string; event_teamsize: string,event_qr:string,event_register_link:string,event_rulebook:string  })}
            />
          ))}
        </div>
        {selectedEvent && (
