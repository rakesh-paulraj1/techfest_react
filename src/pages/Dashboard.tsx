      ...
      <div className="card">
        ...
        <div className="main">
          ...
          <div className="button-container">
            ...
            <a href="https://www.instagram.com/srmist.trichy/" target="_blank" rel="noopener noreferrer">
              <svg
                className="svg"
            ...
            <button className="button">
            <a href="https://www.facebook.com/srmist.trichy/" target="_blank" rel="noopener noreferrer">
              <svg
                className="svg"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
            ...
            <button className="button">
            <a href="https://www.youtube.com/@srminstituteofscienceandte1060" target="_blank" rel="noopener noreferrer">
              <svg
                className="svg"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
