...
export const HeroParallax = () => {
  ...
  // Make the list of cards move upwards as the user scrolls
  ...
  const translateY = useSpring(
    useTransform(scrollYProgress, [0, 0.2], [100, -100]), // Adjusted to move the cards upwards
    springConfig
  );
    ...
    >
      ...
      <motion.div
        style={{
          rotateX,
          rotateZ,
          translateY, // Apply the translateY transformation
          opacity,
        }}
        className=""
      >
